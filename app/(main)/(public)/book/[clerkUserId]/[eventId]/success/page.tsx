...
//     if (!event) return (
//         <div className="bg-red-50 border-red-200 text-red-800 px-4 py-3 rounded-md flex items-center gap-3">
...
//             </CardHeader>
//             <CardContent> you should receive an email confirmation</CardContent>
//         </Card>
//     )
// }
